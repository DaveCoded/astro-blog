...
<Dropcap>Self-hosting</Dropcap> web fonts is the best font-loading strategy for many websites. Done correctly,
it yields the best performance results and gives you the most options and flexibility. The only reason
to avoid it might be that you get too much control, which puts the onus of understanding how to optimise
web fonts all on you. But that's another matter entirely.
